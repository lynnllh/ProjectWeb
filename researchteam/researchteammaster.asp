...
<div class="webbody">
  ...
  <tr>
    <th class="currentptable" scope="col"><img src="../indeximages/箭头.jpg" width="20" height="17" style="vertical-align:middle">
</th>
...
%>
  <table width="570" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <th  rowspan="5" width="150" scope="col" class="footsong"><img src="upload/<%=(Recordset1.Fields.Item("picture").Value)%>" width="75" height="100"></th>
