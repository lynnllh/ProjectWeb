...
Recordset1_cmd.CommandText = "SELECT ID, recordnum, conname FROM researchteam ORDER BY recordnum ASC" 
...
%>
    <tr height="20">
      <td  align="center"  class="footsong"><%=(Recordset1.Fields.Item("recordnum").Value)%></td>
      <td class="footsong"><%=(Recordset1.Fields.Item("conname").Value)%></td>
      <td  class="footsong" align="center"><a href="backresearchteamadd.asp" >添加</a> <A HREF="backresearchteammod.asp?<%= Server.HTMLEncode(MM_keepNone) & MM_joinChar(MM_keepNone) & "ID=" & Recordset1.Fields.Item("ID").Value %>" >修改</A> <A HREF="backresearchteamdel.asp?<%= Server.HTMLEncode(MM_keepNone) & MM_joinChar(MM_keepNone) & "ID=" & Recordset1.Fields.Item("ID").Value %>">删除</A> <A HREF="backresearchteamintroduction.asp?<%= Server.HTMLEncode(MM_keepNone) & MM_joinChar(MM_keepNone) & "ID=" & Recordset1.Fields.Item("ID").Value %>" target="_blank">添加文件</A></td>
    </tr>
    <% 
