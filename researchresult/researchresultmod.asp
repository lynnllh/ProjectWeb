...
If (CStr(Request("MM_update")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "UPDATE researchresult SET moddate = ?, dir = ?, conname = ?, place = ? WHERE ID = ?" 
...
Recordset1_cmd.CommandText = "SELECT * FROM researchresult WHERE ID = ?" 
...
Recordset2_cmd.CommandText = "SELECT dir FROM researchdirection" 
...
<div id="condiv">
  <form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1">
    <table  width="670" cellpadding="2" >
      <tr valign="baseline">
        <td nowrap width="200" align="right">见刊日期</td>
...
%>
          <option value="<%=(Recordset2.Fields.Item("dir").Value)%>"><%=(Recordset2.Fields.Item("dir").Value)%></option>
          <%
  Recordset2.MoveNext()
Wend
