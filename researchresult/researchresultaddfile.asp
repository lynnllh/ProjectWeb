...
<title>论文成果</title>
<link href="../researchdirection/backdir.css" rel="stylesheet" type="text/css">
<!-- InstanceEndEditable -->
<style type="text/css">
body {
...
<table width="220" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <tr>
  <td colspan="2"  align="center">注意事项：文件名需与前面所填文件名一致。论文PDF大小不能超过10M。
  </td>
  </tr>
    </table>
        <form action="upload.asp" method="post" enctype="multipart/form-data"><table width="670">
