...
If (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "DELETE FROM researchresult WHERE ID = ?"
...
<div id="condiv"><form name="form1" action="<%=MM_editAction%>" method="POST"><table border="0" width="670">
  ...
  <tr>
    <td align="center"><input name="删除" type="submit" id="删除" value="删除"><input name="返回" type="button" id="返回" onClick="MM_goToURL('parent','researchresultlist.asp');return document.MM_returnValue" value="返回"></td>
