...
If (Request.QueryString("dir") <> "") Then 
  Recordset2__MMColParam = Request.QueryString("dir")
End If
%>
<%
Dim Recordset2
...
Recordset2_cmd.CommandText = "SELECT * FROM researchresult WHERE dir = ? ORDER BY moddate DESC" 
...
%>
  ...
  <tr>
    ...
    <th width="20"></th>
    <th  width="100" align="left">发布日期</th>
  </tr>
    <% 
While ((Repeat2__numRows <> 0) AND (NOT Recordset2.EOF)) 
%>
      <tr>
        <th scope="col" width="400" align="left" class="footsong" height="45">&nbsp;<a href="upload/<%=(Recordset2.Fields.Item("place").Value)%>" class="dellink" onmouseover="this.style.color='blue'" onmouseout="this.style.color='black'"><%=(Recordset2.Fields.Item("conname").Value)%></a></th>
        <th></th>
    ...
    <hr>
      ...
      <table border="0" align="center">
        <tr>
 		...
 		<table align="center">
        <tr>
        <td> 记录 <%=(Recordset2_first)%> 到 <%=(Recordset2_last)%> (总共 <%=(Recordset2_total)%>)</td></tr></table>
      </div>
