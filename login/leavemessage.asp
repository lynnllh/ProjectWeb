...
If (CStr(Request("MM_insert")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "INSERT INTO message (title, moddate, content) VALUES (?, ?, ?)" 
    ...
    MM_editCmd.Parameters.Append MM_editCmd.CreateParameter("param3", 203, 1, 1073741823, Request.Form("content")) ' adLongVarWChar
    MM_editCmd.Execute
...
Recordset1_cmd.CommandText = "SELECT * FROM message" 
    ...
    <div class="navbar">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <th width="114" scope="col" onmouseover="this.bgColor='#026bff'" onmouseout="this.bgColor=''"><a  href="leavemessage.asp" class="navword">组内建议</a></th>
...
<table width="220" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <th class="currentptable" scope="col"><a href="../backsystemindex.asp" class="dellink" onmouseover="this.style.color='blue'" onmouseout="this.style.color='black'" >首页</a>-><a href="leavemessage.asp" class="dellink" onmouseover="this.style.color='blue'" onmouseout="this.style.color='black'">组内建议</a></th>
  </tr>
</table>
</div>
<div id="logincondiv"><form name="form1" action="<%=MM_editAction%>" method="POST"><table border="0" width="670">
  <tr>
    <td width="200" align="right">标题</td>
    <td><input name="title" type="text" id="title" size="40" maxlength="255"></td>
  </tr>
    ...
    <td><textarea name="content" cols="45" rows="8" id="content"></textarea></td>
      ...
      <td  align="right"></td>
    <td><input name="提交" type="submit" value="提交"><input name="重置" type="reset" id="重置" value="重置"></td>
  </tr>
  </table>
