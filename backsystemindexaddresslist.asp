...
Recordset1_cmd.CommandText = "SELECT * FROM researchteam ORDER BY recordnum ASC" 
...
<div id="condiv"><table width="670" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td scope="col" align="center" width="80">序号</td>
    <td scope="col" align="left" width="100">姓名</td>
    <td scope="col" align="left" width="180">手机</td>
    <td scope="col" align="left" >工作单位</th>
  </tr>
  <% 
While ((Repeat1__numRows <> 0) AND (NOT Recordset1.EOF)) 
%>
    <tr height="20">
      <td  class="footsong"  align="center"><%=(Recordset1.Fields.Item("recordnum").Value)%></td>
      <td class="footsong"><A HREF="backsystemindexaddressdetail.asp?<%= Server.HTMLEncode(MM_keepNone) & MM_joinChar(MM_keepNone) & "ID=" & Recordset1.Fields.Item("ID").Value %>" class="dellink" onmouseover="this.style.color='blue'" onmouseout="this.style.color='black'"><%=(Recordset1.Fields.Item("conname").Value)%></A></td>
      <td class="footsong"><%=(Recordset1.Fields.Item("tel").Value)%></td>
      <td class="footsong"><%=(Recordset1.Fields.Item("workplace").Value)%></td>
    </tr>
    <% 
