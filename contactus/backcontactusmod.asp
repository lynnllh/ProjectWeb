...
If (CStr(Request("MM_update")) = "form1") Then
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "UPDATE contactus SET recordnum = ?, conname = ?, postcode = ?, tel = ?, email = ?, address = ?, detailaddress = ? WHERE ID = ?" 
    ...
    MM_editRedirectUrl = "backcontactusmod.asp"
    If (Request.QueryString <> "") Then
...
Recordset1_cmd.CommandText = "SELECT * FROM contactus WHERE ID = ?" 
...
<table width="220" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <th class="currentptable" scope="col"><a href="../backsystemindex.asp" class="dellink" onmouseover="this.style.color='blue'" onmouseout="this.style.color='black'">首页</a>-><a href="backcontactusmod.asp" class="dellink" onmouseover="this.style.color='blue'" onmouseout="this.style.color='black'">联系我们</a></th>
  </tr>
</table>
</div>
<div id="condiv">
  <form method="POST" action="<%=MM_editAction%>" name="form1">
    <table width="670" border="0" cellpadding="2">
      ...
      <tr valign="baseline">
        ...
        <td><input type="text" name="postcode" value="<%=(Recordset1.Fields.Item("postcode").Value)%>" size="32"></td>
      </tr>
      <tr valign="baseline">
      ...
      <tr valign="baseline">
        <td nowrap align="right">学校地址</td>
        <td><input type="text" name="address" value="<%=(Recordset1.Fields.Item("address").Value)%>" size="32"></td>
      </tr>
      <tr valign="baseline">
        <td nowrap align="right">办公室地址</td>
        <td><input type="text" name="detailaddress" value="<%=(Recordset1.Fields.Item("detailaddress").Value)%>" size="32"></td>
      </tr>
      <tr valign="baseline">
