...
Recordset1_cmd.CommandText = "SELECT * FROM message ORDER BY moddate DESC" 
...
<table width="670" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td scope="col" width="90" align="center">发布时间</td>
    <td scope="col" align="left">标题</td>
    <td  width="150" align="center">相关操作</td>
  </tr>
  <% 
While ((Repeat1__numRows <> 0) AND (NOT Recordset1.EOF)) 
%>
    <tr height="20">
      <td class="footsong">&nbsp;<%=(Recordset1.Fields.Item("moddate").Value)%></td>
      <td class="footsong"><%=(Recordset1.Fields.Item("title").Value)%></td>
      <td align="center" class="footsong"><A HREF="backsystemindexdetail.asp?<%= Server.HTMLEncode(MM_keepNone) & MM_joinChar(MM_keepNone) & "ID=" & Recordset1.Fields.Item("ID").Value %>">查看</A> <A HREF="backsystemindexdel.asp?<%= Server.HTMLEncode(MM_keepNone) & MM_joinChar(MM_keepNone) & "ID=" & Recordset1.Fields.Item("ID").Value %>">删除</A></td>
    </tr>
    <% 
...
<table align="center">
<tr>
<td> 记录 <%=(Recordset1_first)%> 到 <%=(Recordset1_last)%> (总共 <%=(Recordset1_total)%>)
</td>
</tr>
</table>
