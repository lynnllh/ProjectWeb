...
%>
    <tr height="20">
      ...
      <td  class="footsong" align="center"><a href="teamactivityadd.asp">添加</a> <A HREF="teamactivitymod.asp?<%= Server.HTMLEncode(MM_keepNone) & MM_joinChar(MM_keepNone) & "ID=" & Recordset1.Fields.Item("ID").Value %>">修改</A> <A HREF="teamactivitydel.asp?<%= Server.HTMLEncode(MM_keepNone) & MM_joinChar(MM_keepNone) & "ID=" & Recordset1.Fields.Item("ID").Value %>">删除</A> <a href="teamactivityaddfile.asp" target="_blank">添加文件</a></td>
    </tr>
    <% 
...
<table align="center">
  <tr>
<td align="center"> 记录 <%=(Recordset1_first)%> 到 <%=(Recordset1_last)%> (总共 <%=(Recordset1_total)%>)</td>
</tr>
</table>
