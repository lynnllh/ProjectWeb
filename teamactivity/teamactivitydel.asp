...
If (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "DELETE FROM teamactivity WHERE ID = ?"
...
<div id="condiv"><form ACTION="<%=MM_editAction%>" METHOD="POST" name="form1"><table border="0" width="670">
<tr>
    <th>&nbsp;
    </th>
    </tr>
    ...
    <tr>
    <td  align="center"><input name="删除" type="submit" id="删除" value="提交"><input name="返回" type="button" id="返回" onClick="MM_goToURL('parent','teamactivitylist.asp');return document.MM_returnValue" value="按钮">
    </td>
    </tr>
  </table>
