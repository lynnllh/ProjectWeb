...
Recordset1_cmd.CommandText = "SELECT * FROM researchdirection ORDER BY recordnum ASC" 
    ...
    <div class="navbar">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <th width="128" scope="col" onmouseover="this.bgColor='#026bff'" onmouseout="this.bgColor=''"><a href="researchdirection.asp" class="navword">研究方向</a></th>
...
<table width="220" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <th class="currentptable" scope="col"><a href="../index.asp" class="dellink" onmouseover="this.style.color='blue'" onmouseout="this.style.color='black'">首页</a>-><a href="researchdirection.asp" class="dellink" onmouseover="this.style.color='blue'" onmouseout="this.style.color='black'">研究方向</a></th>
  </tr>
</table>
...
%>
    <table width="570" border="0" cellspacing="0" cellpadding="2">
      <tr>
        ...
        <th width="15" align="left" scope="col" class="footsong"><%=(Recordset1.Fields.Item("recordnum").Value)%>.</th>
        <th colspan="2" align="left" scope="col" class="footsong"><%=(Recordset1.Fields.Item("shortdir").Value)%></th>
        </tr>
      <tr>
        <th width="30" align="left" scope="col"></th>
        <th width="15" align="left" scope="col"></th>
        <th width="25" align="left" scope="col"></th>
        <th  align="left" scope="col" class="footsong"><a href="upload/<%=(Recordset1.Fields.Item("file1").Value)%>" class="dellink" onmouseover="this.style.color='blue'" onmouseout="this.style.color='black'"  target="_blank"><%=(Recordset1.Fields.Item("longdir1").Value)%></a></th>
        </tr>
      <tr>
        <th width="30" align="left" scope="col"></th>
        <th width="15" align="left" scope="col"></th>
        <th  align="left" scope="col"></th>
        <th  align="left" scope="col" class="footsong"><a href="upload/<%=(Recordset1.Fields.Item("file2").Value)%>" class="dellink" onmouseover="this.style.color='blue'" onmouseout="this.style.color='black'" target="_blank"><%=(Recordset1.Fields.Item("longdir2").Value)%></a></th>
        </tr>
      <tr>
        <th width="30" align="left" scope="col"></th>
        <th width="15" align="left" scope="col"></th>
        <th  align="left" scope="col"></th>
        <th  align="left" scope="col" class="footsong"><a href="upload/<%=(Recordset1.Fields.Item("file3").Value)%>" class="dellink" onmouseover="this.style.color='blue'" onmouseout="this.style.color='black'" target="_blank"><%=(Recordset1.Fields.Item("longdir3").Value)%></a></th>
        </tr>
      <tr>
        <th width="30" align="left" scope="col"></th>
        <th width="15" align="left" scope="col"></th>
        <th  align="left" scope="col"></th>
        <th  align="left" scope="col" class="footsong"><a href="upload/<%=(Recordset1.Fields.Item("file4").Value)%>" class="dellink" onmouseover="this.style.color='blue'" onmouseout="this.style.color='black'" target="_blank"><%=(Recordset1.Fields.Item("longdir4").Value)%></a></th>
        </tr>
      <tr>
        <th width="30" align="left" scope="col"></th>
        <th width="15" align="left" scope="col"></th>
        <th  align="left" scope="col"></th>
        <th  align="left" scope="col" class="footsong"><a href="upload/<%=(Recordset1.Fields.Item("file5").Value)%>" class="dellink" onmouseover="this.style.color='blue'" onmouseout="this.style.color='black'" target="_blank"><%=(Recordset1.Fields.Item("longdir5").Value)%></a></th>
        </tr>
    </table>
