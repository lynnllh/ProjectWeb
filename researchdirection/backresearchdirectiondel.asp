...
If (CStr(Request("MM_delete")) = "form1" And CStr(Request("MM_recordId")) <> "") Then
  ...
  If (Not MM_abortEdit) Then
    ...
    MM_editCmd.CommandText = "DELETE FROM researchdirection WHERE ID = ?"
...
<div id="backcondiv">
<form name="form1" action="<%=MM_editAction%>" method="POST"><table width="570" border="0" cellspacing="0" cellpadding="0" align="center">
	<tr>
    <th>&nbsp;
    </th>
    </tr>
  ...
  <tr>
    <th scope="col"><input name="删除" type="submit" id="删除" value="删除"><input name="返回" type="button" id="返回" onClick="MM_goToURL('parent','backresearchdirectionlist.asp');return document.MM_returnValue" value="返回"></th>
  </tr>
</table>
