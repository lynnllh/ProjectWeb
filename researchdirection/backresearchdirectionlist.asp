...
Recordset1_cmd.CommandText = "SELECT ID, recordnum, shortdir FROM researchdirection ORDER BY recordnum ASC" 
...
<table border="0" width="670">
  ...
  <% While ((Repeat1__numRows <> 0) AND (NOT Recordset1.EOF)) %>
    <tr height="20">
      ...
      <td class=" footsong"><%=(Recordset1.Fields.Item("shortdir").Value)%></td>
      <td class=" footsong" align="center"><a href="backresearchdirectionadd.asp">添加</a> <A HREF="backresearchdirectionmod.asp?<%= Server.HTMLEncode(MM_keepNone) & MM_joinChar(MM_keepNone) & "ID=" & Recordset1.Fields.Item("ID").Value %>" >修改</A> <A HREF="backresearchdirectiondel.asp?<%= Server.HTMLEncode(MM_keepNone) & MM_joinChar(MM_keepNone) & "ID=" & Recordset1.Fields.Item("ID").Value %>">删除</A> <a href="backresearchdirectionaddfile.asp" target="_blank">添加文件</a></td>
    </tr>
    <% 
